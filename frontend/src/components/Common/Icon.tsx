...
const iconPaths: Record<string, React.ReactNode> = {
  ...
  check_circle: <path d="M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2Zm4.2 7.8-5.1 5.6a1 1 0 0 1-1.4.1l-2.3-2.1a1 1 0 1 1 1.3-1.5l1.6 1.4 4.4-4.8a1 1 0 1 1 1.5 1.3Z" />,
  ...
  schedule: <path d="M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2Zm1 5a1 1 0 0 0-2 0v5a1 1 0 0 0 .3.7l3 3a1 1 0 1 0 1.4-1.4L13 11.6Z" />,
